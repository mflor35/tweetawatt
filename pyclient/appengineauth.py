...
users_email_address = "user@gmail.com"
users_password      = "password"
my_app_name = "wattcher"
reportsubmit_uri = 'http://wattcher.appspot.com/report'
tweetreport_uri = 'http://wattcher.appspot.com/tweetreport'
...
def sendreport(sensornum, watt):
    ...
    serv_uri = reportsubmit_uri + "?watt="+str(watt)+"&sensornum="+str(sensornum)
